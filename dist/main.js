(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["Node.js"] = factory();
	else
		root["Node.js"] = factory();
})(global, function() {
...
var connection = new ConnectionBuilder().connectTo("dotnet", "run", "--project", "./dotnet/core").build();

connection.onDisconnect = function () {
  console.log("lost");
};

connection.send("greeting", "from C#", function (response) {
